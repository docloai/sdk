 ...
 * import { createFlow } from '@docloai/flows';
 * import { parse, extract } from '@docloai/nodes';
 *
 ...
 * ### Serialization
 * ```typescript
 * import { buildFlowFromConfig } from '@docloai/flows';
 *
 * const flowDef = {
 *   version: '1.0.0',
 *   steps: [
...
import type { ProviderRegistry } from '@docloai/nodes';
