...
```bash
pnpm add @docloai/providers-unsiloed
```
...
```typescript
import { unsiloedParseProvider } from '@docloai/providers-unsiloed';
...
```typescript
import { unsiloedExtractProvider } from '@docloai/providers-unsiloed';
...
```typescript
import { unsiloedTablesProvider } from '@docloai/providers-unsiloed';
...
```typescript
import { unsiloedClassifyProvider } from '@docloai/providers-unsiloed';
import { createFlow, categorize } from '@docloai/flows';
...
```typescript
import { unsiloedSplitProvider } from '@docloai/providers-unsiloed';
import { createFlow, split } from '@docloai/flows';
...
} from '@docloai/providers-unsiloed';
import { createFlow, parse, categorize, extract } from '@docloai/flows';
...
```typescript
import { PROVIDER_METADATA, getProvidersForNode } from '@docloai/providers-unsiloed';
...
- Issues: https://github.com/docloai/sdk/issues
