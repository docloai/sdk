 ...
 * @example
 * ```typescript
 * import { unsiloedParseProvider, unsiloedExtractProvider } from '@docloai/providers-unsiloed';
 *
...
}): import('@docloai/core').OCRProvider;

export function createUnsiloedProvider(opts: {
  type: 'extract' | 'tables' | 'classify' | 'split';
  apiKey: string;
  config?: Record<string, any>;
}): import('@docloai/core').VLMProvider;

export function createUnsiloedProvider(opts: {
  type: 'parse' | 'extract' | 'tables' | 'classify' | 'split';
  apiKey: string;
  config?: Record<string, any>;
}): import('@docloai/core').OCRProvider | import('@docloai/core').VLMProvider {
