import { node, type NodeDef, type FlowContext, type FlowResult, type StepMetric, type NodeCtx } from '@doclo/core';
 ...
 *
 * This must match the FlowBuilder type in @doclo/flows/flow-registry
